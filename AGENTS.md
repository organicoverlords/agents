...
## Entering a repo
- For each distinct technical work item, refresh only the live `bootstrap-glance` first. Reuse the shared contract and known task/issue context already loaded in the chat; do not reread RULES/AGENTS or enumerate GitHub/Busy as part of bootstrap.
